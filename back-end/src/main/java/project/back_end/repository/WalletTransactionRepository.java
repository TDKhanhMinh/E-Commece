...
public interface WalletTransactionRepository extends JpaRepository<WalletTransaction, Long> {
        ...
        Page<WalletTransaction> getWalletTransactionsByStatusAndTypeAndActionAndCreatedAtBetween(
                        TransactionStatus status, TransactionType type, TransactionAction action,
                        LocalDateTime createdAtAfter, LocalDateTime createdAtBefore, Pageable pageable);

        List<WalletTransaction> findAllByShipperProfileAndActionAndStatusAndTypeAndCreatedAtBetween(
                        ShipperProfile shipperProfile, TransactionAction action, TransactionStatus status,
                        TransactionType type, LocalDateTime createdAtAfter, LocalDateTime createdAtBefore);
        ...
        boolean existsByShipperProfileAndActionAndStatus(
