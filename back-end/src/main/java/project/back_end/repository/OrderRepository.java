...
public interface OrderRepository extends JpaRepository<Order, Long> {
        ...
        @EntityGraph(attributePaths = {"orderItems", "deliveryAddress"})
        ...
        List<Order> findByUserIdAndStatusOrderByCreatedAtDesc(@Param("userId") Long userId,
                        @Param("status") OrderStatus status);

        @Query("SELECT o FROM Order o WHERE o.user.id = :userId AND o.status = :status ORDER BY o.createdAt DESC")
        Page<Order> findByUserIdAndStatusOrderByCreatedAtDesc(@Param("userId") Long userId,
        ...
        Page<Order> filterOrders(
                        ...
                        @Param("deliveryStartDate") LocalDateTime deliveryStartDate,
                        @Param("deliveryEndDate") LocalDateTime deliveryEndDate,
                        Pageable pageable);
