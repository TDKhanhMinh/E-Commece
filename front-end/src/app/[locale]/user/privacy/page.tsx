    ...
    return (
        <div className="min-h-screen bg-slate-50/50 pb-20">
            ...
            <div className="relative z-20 container mx-auto -mt-16 max-w-5xl px-4">
                <Card className="overflow-hidden rounded-[2.5rem] border-none bg-white/90 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] backdrop-blur-2xl">
                            ...
                            <div className="space-y-16 p-8 md:p-16">
                                ...
                                <section className="space-y-8">
                                    <div className="flex items-center gap-4 border-l-4 border-blue-500 pl-6">
                                        <div className="rounded-2xl bg-blue-100 p-3 text-blue-600 shadow-inner">
                                        ...
                                        <Table>
                                            <TableHeader className="bg-slate-50/50">
                                                <TableRow className="hover:bg-transparent">
                                                    <TableHead className="h-14 font-bold text-slate-800">
                                                        Loại dữ liệu
                                                    </TableHead>
                                                    <TableHead className="h-14 font-bold text-slate-800">
                                                        Ví dụ cụ thể
                                                    </TableHead>
                                                    <TableHead className="h-14 pr-8 text-right font-bold text-slate-800">
                                                        Mục đích
                                                    </TableHead>
                                                </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                                {DATA_COLLECTION.map(
                                                    (item, index) => (
                                                        <TableRow
                                                            key={index}
                                                            className="h-16 border-slate-50 transition-colors hover:bg-slate-50/50"
                                                        >
                                                            <TableCell className="font-bold">
                                                                <span
                                                                    className={`rounded-xl px-4 py-1.5 text-xs tracking-wider uppercase ${item.color}`}
                                                                >
                                                                    {item.type}
                                                                </span>
                                                            </TableCell>
                                                            ...
                                                            <TableCell className="pr-8 text-right text-sm text-slate-500 italic">
                                                                {item.purpose}
                                                            </TableCell>
                                                        </TableRow>
                                                    )
                                ...
                                <section className="space-y-8">
                                    <div className="flex items-center gap-4 border-l-4 border-purple-500 pl-6">
                                        <div className="rounded-2xl bg-purple-100 p-3 text-purple-600 shadow-inner">
                                    ...
                                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                        {USAGE_INFO.map((item, index) => (
                                            <div
                                                key={index}
                                                className="group relative rounded-[2rem] border border-slate-100 bg-white p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10"
                                            >
                                                <div
                                                ...
                                                <div className="flex items-start gap-5">
                                                    ...
                                                    <div>
                                                        <h4 className="mb-2 text-xl font-black text-slate-900 italic">
                                                            {item.title}
                                                        </h4>
                                ...
                                <section className="space-y-8">
                                    ...
                                    <div className="flex flex-col items-center gap-8 rounded-[2.5rem] border border-emerald-100 bg-emerald-50/50 p-10 md:flex-row">
                                        <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-white shadow-xl shadow-emerald-200">
                                            <ShieldCheck className="h-10 w-10 text-emerald-600" />
                                        </div>
                                        <div className="space-y-3 text-center md:text-left">
                                            <h4 className="text-xl font-black text-emerald-900 uppercase">
                                ...
                                <section className="group relative overflow-hidden rounded-[3rem] bg-slate-900 p-10 text-white">
                                    <div className="relative z-10 flex flex-col justify-between gap-8 md:flex-row md:items-center">
                                        <div className="space-y-3">
                                            ...
                                            <p className="max-w-lg font-medium text-slate-400">
                                ...
                                {/* FOOTER */}
                                <footer className="flex flex-col items-center gap-6 border-t border-slate-100 pt-16">
                                    ...
                                    <a
                                        ...
                                        className="group inline-flex items-center gap-4 rounded-2xl bg-slate-900 px-10 py-5 text-white shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:bg-indigo-600"
                                    >
